...
-  [ ] lab01 - [Лабораторная работа посвящена изучению **gitscm** и подготовительными материалами для последующих работ](labs/lab01/README.md)
    ...
    -  Пример выполненного отчета со скриншотами [1](https://github.com/MishaBary/risk_lab1), [2](https://gist.github.com/LolTaun/1257b551ed387daaf3bb643091301819), [3](https://gist.github.com/KOLGOTKA/77bbda13092e8879b2cc91fdb0b818e9). Для всех отчетов следует избегать скриншотов и делать со вставками вывода из консоли и описания используемых команд, флагов и что они означают для понимания принципа их работы.
-  [ ] lab02 - [Лабораторная работа посвящена изучению работы *nix, контролей прав доступа, оперированию процессов](labs/lab02/README.md)
    ...
    -  Пример драфта отчета лежит, который дорабатывается [тут](https://gist.github.com/MishaBary/21ab63f83292a86268e039d484a86411)
