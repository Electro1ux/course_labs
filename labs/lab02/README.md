...
Для сдачи данной работы также будет требоваться ответить на дополнительыне вопросы по описанным темам. В данной работе предполагается подготовка только `gist` и репозитория с `README.md` с приложением сопроводительных скриншотов.
...
<details><summary><strong>Иы</strong></summary><p>
